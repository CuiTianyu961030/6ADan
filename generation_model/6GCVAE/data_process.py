...
def data_save(addresses, address_class):
    ...
    dataset_path = 'generation_model/6GCVAE/data/processed_data/data.txt'
    addresses_path = 'generation_model/6GCVAE/data/processed_data/flatten_addresses.txt'
...
def cluster_process(cluster_path):
    ...
    data_path = "generation_model/6GCVAE/data/processed_data/gasser_data_1107.txt"
    ...
    for cluster in cluster_data:
        f = open("generation_model/6GCVAE/data/processed_data/gasser_cluster_" + str(count) + "_1107.txt", "w")
...
if __name__ == '__main__':
    print("开始执行 data_process.py ...")
    gasser_ipv6hitlist = 'generation_model/6GCVAE/data/public_datasets/responsive-addresses.txt'
    #
