...
generated_path = 'generation_model/6GCVAE/data/generated_data/6gcvae_generation.txt'
...
def run_model():
    ...
    vae.save_weights('generation_model/6GCVAE/models/gcnn_vae.model')
