...
source_file = 'generation_model/6GAN/data/source_data/responsive-addresses.work'
source_data = 'generation_model/6GAN/data/source_data/responsive-addresses.data'

rfc_profile = 'generation_model/6GAN/data/save_data/rfc_profile.txt'
ec_profile = 'generation_model/6GAN/data/save_data/ec_profile.txt'
ec_cluster = 'generation_model/6GAN/data/save_data/ec_cluster.txt'
ipv62vec_profile = 'generation_model/6GAN/data/save_data/ipv62vec_profile.txt'

category_path = 'generation_model/6GAN/data/category_data/'
...
class RFCBased(object):
    def __init__(self, batch_size):
        self.classify_dict = {}
        self.cmd = 'cat generation_model/6GAN/data/source_data/responsive-addresses.work | ../../../../Tools/ipv6toolkit/addr6 -i -d > generation_model/6GAN/data/save_data/rfc_profile.txt'
...
class EntropyClustering(object):
    def __init__(self, batch_size, k=4):
        ...
        self.k = k
        self.profile_cmd = 'cat generation_model/6GAN/data/source_data/responsive-addresses.data | ' + \
                           '../../../../Tools/entropy-clustering/profiles > generation_model/6GAN/data/save_data/ec_profile.txt'
        self.cluster_cmd = 'cat generation_model/6GAN/data/save_data/ec_profile.txt | ' + \
                           '../../../../Tools/entropy-clustering/clusters -kmeans -k ' \
                           + str(k) + ' > generation_model/6GAN/data/save_data/ec_cluster.txt'
