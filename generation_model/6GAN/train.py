...
dataset_path = "generation_model/6GAN/data/source_data/"
...
save_path = "generation_model/6GAN/data/save_data/"
log_file = save_path + "train.log"
eval_file = save_path + "eval_file.txt"
eval_text_file = save_path + "eval_text_file.txt"

candidate_path = "generation_model/6GAN/data/candidate_set/"
model_path = "generation_model/6GAN/models/"
