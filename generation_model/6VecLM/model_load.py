...
if __name__ == "__main__":
    print("开始执行 model_load.py ...")
    word2vec_model = word2vec.Word2Vec.load(word2vec_model_path)

    model = torch.load("generation_model/6VecLM/models/ipv6_transformer_s6_e10_t0015.model")
    model.eval()
    f = open(data_path, "r")
    ...
    generation_path = "generation_model/6VecLM/data/generation_data/candidate_s6_e1_t" + str(temperature) + ".txt"
